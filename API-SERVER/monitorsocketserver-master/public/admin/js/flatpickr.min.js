/* flatpickr v4.5.4,, @license MIT */ ! function(e, t) {
            ...
            if (0 !== g.selectedDates.length) {
                void 0 !== e && "blur" !== e.type && function(e) {
                    ...
                    var a = parseFloat(n.getAttribute("data-min")),
                        ...
                        l = parseFloat(n.getAttribute("data-step")),
            ...
            if (13 === e.keyCode && t) {
                ...
                switch (e.keyCode) {
                    ...
                    case 40:
                        ...
                        break;
                    case 9:
                        var c = g.calendarContainer.childElementCount,
                            d = 0;
                        ...
                        if (g.calendarContainer.style.top = u + "px", p)
                            if (h) {
                                var v = document.styleSheets[0],
                                    D = window.document.body.offsetWidth,
                ...
                function() {
                    if (g.config.wrap && ["open", "close", "toggle", "clear"].forEach(function(e) {
                        ...
                        g._debouncedChange = r(F, y), g.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && _(g.daysContainer, "mouseover", function(e) {
                            ...
                            capture: !0
                        }), !0 === g.config.clickOpens && (_(g._input, "focus", g.open), _(g._input, "mousedown", N(g.open))), void 0 !== g.daysContainer && (_(g.monthNav, "mousedown", N(ve)), _(g.monthNav, ["keyup", "increment"], S), _(g.daysContainer, "mousedown", N(le))), void 0 !== g.timeContainer && void 0 !== g.minuteElement && void 0 !== g.hourElement && (_(g.timeContainer, ["increment"], x), _(g.timeContainer, "blur", x, {
                            capture: !0
